      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            ...
            {/* Mobile Links */}
            <Link to="/provider/dashboard" onClick={() => setMenuOpen(false)} className="hover:text-white transition">
              Home
            </Link>
            <Link to="/provider/postjob" onClick={() => setMenuOpen(false)} className="hover:text-white transition">
              Post Job
            </Link>
            <Link to="/provider/notification" onClick={() => setMenuOpen(false)} className="hover:text-white transition">
              Notification
            </Link>
            <Link to="/provider/profile" onClick={() => setMenuOpen(false)} className="hover:text-white transition">
              Profile
            </Link>
